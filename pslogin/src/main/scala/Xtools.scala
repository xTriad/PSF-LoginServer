...
object Xtools {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // TODO decode packet
    for (file <- new File("D:/Games/PlanetSide/psforever/GameCaptures/").listFiles) {
      val FileToRead = file.toString
      val FileToWrite = "D:/Games/PlanetSide/psforever/_GameCaptures/" + file.getName().split(".txt")(0) + "_decoded.txt"
